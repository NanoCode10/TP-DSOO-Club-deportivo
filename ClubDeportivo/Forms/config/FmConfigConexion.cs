...
namespace ClubDeportivo.Forms.config
{
    ...
    public sealed class FmConfigConexion : Form
    {
        ...
        private void Probar()
        {
            try
            {
                var cs = $"server={txtServidor.Text};port={txtPuerto.Text};user={txtUsuario.Text};password={txtClave.Text};Database={txtBase.Text};";
            ...
            {
                MessageBox.Show("No se pudo conectar.\n\n" + ex.Message, "Probar conexión", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void Guardar()
        {
            ...
            {
                MessageBox.Show("Servidor, Puerto, Base y Usuario son obligatorios.", "Validación",
